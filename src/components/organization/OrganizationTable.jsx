 ...
 */
function OrganizationTable({ organizations, onEdit, onDelete, isLoading }) {
  if (isLoading) {
    return (
            ...
            {organizations.length === 0 ? (
              <tr>
                <td colSpan="5" className="px-6 py-12">
                  <EmptyState 
                    title="Không có doanh nghiệp nào"
                    message="Chưa có doanh nghiệp nào trong hệ thống"
                  />
                </td>
              </tr>
            ) : (
                ...
                <tr key={org.organizationId} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold ${
                      ...
                      <span className={`w-2 h-2 rounded-full ${
                        org.status ? 'bg-green-500' : 'bg-red-500'
                      }`}></span>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button
                        onClick={() => onDelete(org.organizationId, org.organizationName)}
