...
/**
 * Major Table Component
 */
function MajorTable({ majors, onEdit, onDelete, isLoading }) {
  if (isLoading) {
    return (
            ...
            {majors.length === 0 ? (
              <tr>
                <td colSpan="5" className="px-6 py-12">
                  <EmptyState 
                    title="Không có ngành nào"
                    message="Chưa có ngành học nào trong hệ thống"
                  />
                </td>
              </tr>
            ) : (
                ...
                <tr key={major.majorId} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold ${
                      ...
                      <span className={`w-2 h-2 rounded-full ${
                        major.status ? 'bg-green-500' : 'bg-red-500'
                      }`}></span>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button
                        onClick={() => onDelete(major.majorId, major.majorName)}
